...
<div class="row" style="background-color:grey;">
  <div class="col-sm-12"><h1 style="text-align:center">HERE ARE SOME INDUSTRIES OF VITARA</h1></div>
...
<div class="table-responsive text-nowrap">
        ...
        <table class="table table-striped" >
          ...
          <tbody>
            <tr>
              <th scope="row">1</th>
              <td>Ganesh Pvt. Ltd.</td>
              <td>01,Industrial Area,Vitara</td>
              <td> 422004</td>
              <td>021-835545</td>
             ...
             <tr>
              <th scope="row">2</th>
              <td>Khushi Corporation</td>
              <td>71,Pinacle Tower,Vitara</td>
              <td> 422334</td>
              <td>021-341117</td>
 ...
 <tr>
              <th scope="row">3</th>
              <td>R.G. Steel</td>
              <td>02,Industrial Area,Vitara</td>
              <td> 422004</td>
              <td>020-346555</td>
 ...
 <tr>
              <th scope="row">4</th>
              <td>Glamour Pharmaceuticals Ltd.</td>
              <td>03,Industrial Area,Vitara</td>
              <td> 422004</td>
              <td>022-905117</td>
              <td>Medicine Plant</td>
              <td>3,100</td>
            </tr>
 <tr>
              <th scope="row">5</th>
              <td>Shayma Cargo Services</td>
              <td>64,Flying Club road,Vitara</td>
              <td> 422332</td>
              <td>020-890517</td>
...
<center><img src="img/ind.jpg" width="80%" height="500px"></center>
