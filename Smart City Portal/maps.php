...
<title>Smart City Project</title>
  ...
  <body style="background-image:url(img/bg3.jpeg); background-size: cover;background-repeat:no-repeat">
...
<div class="row" style="background-color:grey;">
  <div class="col"><h1 style="text-align:center">Here is a Map for you of the City. </h1></div>
</div>
<img src="img\map.jpg" height="600px" style="padding:0 250px">
