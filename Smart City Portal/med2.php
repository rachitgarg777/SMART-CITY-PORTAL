...
<div class="row" style="background-color:grey;">
  <div class="col-sm-12"><h1 style="text-align:center">HERE ARE SOME PHARMACY SHOPS</h1></div>
...
<div class="table-responsive text-nowrap">
        ...
        <table class="table table-striped" >
          ...
          <tbody>
            <tr>
              <th scope="row">1</th>
              <td>Life Point PHARMACY</td>
              <td>32,Sensaure road,vitara</td>
              <td> 422004</td>
              <td>020-435545</td>
              <td>Generic</td>
              <td>Open 24 hrs</td>
             ...
             <tr>
              <th scope="row">2</th>
              <td>NOBLE PHARMACY</td>
              <td>153,Santa road,vitara</td>
              <td> 422114</td>
              <td>021-345517</td>
              <td>Ethical</td>
              <td>Open 24 hrs</td>
 ...
 <tr>
              <th scope="row">4</th>
              <td>Astha PHARMACY</td>
              <td>35,Shyam road,vitara</td>
              <td> 422155</td>
              <td>022-905127</td>
              <td>Ethical</td>
              <td>Open 9am-10pm</td>
 ...
 <tr>
              <th scope="row">5</th>
              <td>Krishna PHARMACY</td>
              <td>77,Dwarka road,vitara</td>
              <td> 422332</td>
              <td>020-390517</td>
              <td>Generic</td>
              <td>Open 8am-11pm</td>
...
<center><img src="img/med5.jpg" width="80%" height="500px"></center>
