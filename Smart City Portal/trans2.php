...
<div class="row" style="background-color:grey;">
  <div class="col-sm-12"><h1 style="text-align:center">RAILWAY SERVICES OF VITARA</h1></div>
...
<tr>
<h2 style="text-align:center"><b>STATION NAME :    VITARA RAILWAY STATION</b></h2></tr>
            <tr>
              <th>S.No.</th>
              <th>TRAIN NAME</th>
              <th>FROM</th>
          ...
          <tbody>
            <tr>
              ...
              <td>Ramgarh</td>
              <td>16:05</td>
              <td>Sleeper\3rd AC\2nd AC</td>
              <td>On Time</td>
            </tr>
             <tr>
              <th scope="row">2</th>
              <td>MAHARAJA Superfast</td>
              <td>Siyana</td>
              <td>VITARA</td>
              <td>19:30</td>
              <td>3rd AC\2nd AC\1st AC</td>
              <td>On Time</td>
            </tr>
 <tr>
              <th scope="row">3</th>
              ...
              <td>New York</td>
              <td>09:10</td>
              <td>General\Sleeper\3rd AC</td>
              <td>CANCELLED</td>
            </tr>
 <tr>
              <th scope="row">4</th>
              <td>VITARA Special</td>
              <td>VITARA</td>
              <td>Balaji</td>
              <td>13:05</td>
              <td>Sleeper\3rd AC\2nd AC\1st AC</td>
              <td>On Time</td>
            </tr>
 <tr>
              <th scope="row">5</th>
            <td>KHUSHI Express</td>
              <td>Heaven</td>
              <td>VITARA</td>
              <td>22:10</td>
              <td>General\Sleeper\3rd AC</td>
...
<center><img src="img/trans22.jpeg" width="80%" height="500px"></center>
