...
<li class="nav-item">
 ...
 <li class="nav-item dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="edu3.php">University</a>
...
<div class="row" style="background-color:grey;">
  <div class="col-sm-12"><h1 style="text-align:center">HOTELS IN VITARA</h1></div>
...
<div class="table-responsive text-nowrap">
        ...
        <table class="table table-striped" >
          ...
          <tbody>
            <tr>
              <th scope="row">1</th>
              <td>VITARA Hotel</td>
              <td>52,Canal Road,Vitara</td>
              <td>Contienental Veg.</td>
              <td>120-535545</td>
              <td>5-Star</td>
              <td>Dine-In\Pack n Carry</td>
            </tr>
             <tr>
              <th scope="row">2</th>
             <td>Emerald Bay Inn</td>
              <td>98,Rama Road,Vitara</td>
              <td>Contienental\Italian Veg.</td>
              <td>020-435545</td>
              <td>7-Star</td>
              <td>AC Dine-In</td>
            </tr>
 <tr>
              <th scope="row">3</th>
             <td>Riveria Regency</td>
              <td>54,Nanni Market,Vitara</td>
              <td>Chinese Veg.</td>
              <td>221-678545</td>
              <td>5-Star</td>
              <td>Dine-In\Pack n Carry</td>
 ...
 <tr>
              <th scope="row">4</th>
              <td>Crowne Plaza</td>
              <td>98,Civil Lines Road,Vitara</td>
              <td>French\South Indian Veg.</td>
              <td>020-777545</td>
              <td>3-Star</td>
              <td>AC Dine-In</td>
            </tr>
 <tr>
              <th scope="row">5</th>
              <td>Hotel Elite</td>
              <td>25,Dwarka Road,Vitara</td>
              <td>North Indian Veg.</td>
              <td>120-895545</td>
              <td>2-Star</td>
              <td>Pack n Carry</td>
            </tr>
...
<center><img src="img/hotels.jpg" width="80%" height="500px"></center>
